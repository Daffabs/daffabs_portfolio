...
const HalSatu = () => {
    return (
        <section className="h-screen flex items-center container px-4">
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-8">
                ...
                >
                    <h1 className="text-white mb-4 text-3xl sm:text-5xl lg:text-7xl font-extrabold">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <Link
                            ...
                            download
                            className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-dark-4 to-dark-2 hover:bg-slate-800 text-white font-bold"
                        >
                ...
                <div className="w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] lg:w-[550px] lg:h-[550px] relative overflow-hidden col-span-12 sm:col-span-4 place-self-center mt-4 lg:mt-0">
                    <Image
                        src="/images/ppo.svg"
                        alt="hero image"
